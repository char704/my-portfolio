...
window.PORTFOLIO = {
  ...
  projects: [
...

   {
      ...
      category: "branding",          // must match your filters: branding | campaign | editorial | ui
      year: "2024",
      client: "Concept Project",
      tagline: "A modular identity system designed for digital-first brands—built to stay consistent across social, UI, and motion.",
    
      story: {
        challenge: "Many early-stage brands look inconsistent across platforms: the logo works, but the system breaks in social posts, UI headers, and short motion pieces.",
        idea: "Create a flexible visual system centered on typography rhythm + a motion grammar—so the brand stays recognizable even when the layout changes.",
        process: "Reference audit → moodboard → type + grid system → color + components → motion rules → mockups for social, UI, and short animations",
        outcome: "Delivered a cohesive kit (logo lockups, grid, type scale, color, social templates, UI header patterns, motion guidelines) that keeps the brand consistent and fast to deploy."
      },
